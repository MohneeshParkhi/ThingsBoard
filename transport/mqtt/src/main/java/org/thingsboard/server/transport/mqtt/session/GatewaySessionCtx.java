...
public class GatewaySessionCtx {
    ...
    // called from MqttTransportHandler Class to interact with Telemetry data..
    public void onDeviceTelemetry(MqttPublishMessage mqttMsg) throws AdaptorException {
        
        // validating Json Payload which return Json Object
        JsonElement json = validateJsonPayload(gatewaySessionId, mqttMsg.payload());
        
        // message id is treated as Request Id
        int requestId = mqttMsg.variableHeader().messageId();
        if (json.isJsonObject()) {
            JsonObject jsonObj = json.getAsJsonObject();
            for (Map.Entry<String, JsonElement> deviceEntry : jsonObj.entrySet()) {
                // checking whether device is connected or not....
                ...
                // Processor is instance of SessionMEssageProcessor
