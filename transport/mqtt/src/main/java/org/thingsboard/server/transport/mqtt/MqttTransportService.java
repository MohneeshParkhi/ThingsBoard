...
public class MqttTransportService {
    ...
    public void init() throws Exception {
        ...
        //gwting bean of class JsonMqttAdaptor.java
        ...
        // bootstrapping server channel, registered using working thread....
        ServerBootstrap b = new ServerBootstrap();
        
        // handling inbound handler using child thread using concept of eventLoop...
        
        // group(EventLoopGroup parentGroup, EventLoopGroup childGroup)--set EventLoopGroup for parent and child
        // b.group(bossGroup, workerGroup) => returns ServerBoostrap class instance
